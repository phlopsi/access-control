...
use phlopsi\access_control\propel\RolesUsers;
use phlopsi\access_control\propel\RolesUsersQuery;
...
class RolesUsersTableMap extends TableMap
{
     ...
     * and findPk*() calls.
     *
     * @param \phlopsi\access_control\propel\RolesUsers $obj A \phlopsi\access_control\propel\RolesUsers object.
     ...
     *
     * @param mixed $value A \phlopsi\access_control\propel\RolesUsers object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \phlopsi\access_control\propel\RolesUsers) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \phlopsi\access_control\propel\RolesUsers object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \phlopsi\access_control\propel\RolesUsers) { // it's a model object
