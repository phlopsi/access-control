...
// hasOnlyDefaultValues()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PermissionsRolesTableMap::translateFieldName('PermissionId',
                        TableMap::TYPE_PHPNAME, $indexType)];
            $this->permissions_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PermissionsRolesTableMap::translateFieldName('RoleId',
                        TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object',
                '\\org\\bitbucket\\phlopsi\\access_control\\propel\\PermissionsRoles'), 0, $e);
        }
    }
...
// doSave()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO permissions_roles (%s) VALUES (%s)', implode(', ', $modifiedColumns),
        ...
        $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aPermission) {
                $result['Permission'] = $this->aPermission->toArray($keyType, $includeLazyLoadColumns,
