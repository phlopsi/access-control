...
abstract class PermissionsRoles implements ActiveRecordInterface
{
     ...
     *
     * @return PermissionsRoles The current object, for fluid interface
     */
    ...
    public function setpermissionId($v)
    {
        ...
        if ($this->permissions_id !== $v) {
            ...
            $this->modifiedColumns[] = PermissionsRolesTableMap::PERMISSIONS_ID;
        }
    ...
    public function setroleId($v)
    {
        ...
        if ($this->roles_id !== $v) {
            $this->roles_id = $v;
            $this->modifiedColumns[] = PermissionsRolesTableMap::ROLES_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \org\bitbucket\phlopsi\access_control\propel\PermissionsRoles object", 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PermissionsRolesTableMap::PERMISSIONS_ID)) {
            $modifiedColumns[':p' . $index++]  = 'PERMISSIONS_ID';
        }
        if ($this->isColumnModified(PermissionsRolesTableMap::ROLES_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PermissionsRolesTableMap::PERMISSIONS_ID)) $criteria->add(PermissionsRolesTableMap::PERMISSIONS_ID, $this->permissions_id);
        if ($this->isColumnModified(PermissionsRolesTableMap::ROLES_ID)) $criteria->add(PermissionsRolesTableMap::ROLES_ID, $this->roles_id);
    ...
    {
        $criteria = new Criteria(PermissionsRolesTableMap::DATABASE_NAME);
        $criteria->add(PermissionsRolesTableMap::PERMISSIONS_ID, $this->permissions_id);
        $criteria->add(PermissionsRolesTableMap::ROLES_ID, $this->roles_id);
