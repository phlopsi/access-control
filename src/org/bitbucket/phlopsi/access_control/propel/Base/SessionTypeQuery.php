 ...
 *
 * @method     ChildSessionTypeQuery leftJoinSessions($relationAlias = null) Adds a LEFT JOIN clause to the query using the Sessions relation
 * @method     ChildSessionTypeQuery rightJoinSessions($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Sessions relation
 * @method     ChildSessionTypeQuery innerJoinSessions($relationAlias = null) Adds a INNER JOIN clause to the query using the Sessions relation
 *
 ...
 *
 * @method     array findByExternalId(string $external_id) Return ChildSessionType objects filtered by the external_id column
 * @method     array findByTreeLeft(int $tree_left) Return ChildSessionType objects filtered by the tree_left column
 * @method     array findByTreeRight(int $tree_right) Return ChildSessionType objects filtered by the tree_right column
 * @method     array findByTreeLevel(int $tree_level) Return ChildSessionType objects filtered by the tree_level column
 * @method     array findById(int $id) Return ChildSessionType objects filtered by the id column
 *
 */
abstract class SessionTypeQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'access_control', $modelName = '\\org\\bitbucket\\phlopsi\\access_control\\propel\\SessionType', $modelAlias = null)
    {
    ...
    {
        if ($criteria instanceof \org\bitbucket\phlopsi\access_control\propel\SessionTypeQuery) {
            return $criteria;
        }
        $query = new \org\bitbucket\phlopsi\access_control\propel\SessionTypeQuery();
        if (null !== $modelAlias) {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(SessionTypeTableMap::ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(SessionTypeTableMap::ID, $keys, Criteria::IN);
    }
    ...
    public function filterByExternalId($externalId = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(SessionTypeTableMap::EXTERNAL_ID, $externalId, $comparison);
    }
    ...
    public function filterByTreeLeft($treeLeft = null, $comparison = null)
    {
        if (is_array($treeLeft)) {
            ...
            if (isset($treeLeft['min'])) {
                $this->addUsingAlias(SessionTypeTableMap::TREE_LEFT, $treeLeft['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($treeLeft['max'])) {
                $this->addUsingAlias(SessionTypeTableMap::TREE_LEFT, $treeLeft['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SessionTypeTableMap::TREE_LEFT, $treeLeft, $comparison);
    }
    ...
    public function filterByTreeRight($treeRight = null, $comparison = null)
    {
        if (is_array($treeRight)) {
            ...
            if (isset($treeRight['min'])) {
                $this->addUsingAlias(SessionTypeTableMap::TREE_RIGHT, $treeRight['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($treeRight['max'])) {
                $this->addUsingAlias(SessionTypeTableMap::TREE_RIGHT, $treeRight['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SessionTypeTableMap::TREE_RIGHT, $treeRight, $comparison);
    }
    ...
    public function filterByTreeLevel($treeLevel = null, $comparison = null)
    {
        if (is_array($treeLevel)) {
            ...
            if (isset($treeLevel['min'])) {
                $this->addUsingAlias(SessionTypeTableMap::TREE_LEVEL, $treeLevel['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($treeLevel['max'])) {
                $this->addUsingAlias(SessionTypeTableMap::TREE_LEVEL, $treeLevel['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SessionTypeTableMap::TREE_LEVEL, $treeLevel, $comparison);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(SessionTypeTableMap::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(SessionTypeTableMap::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(SessionTypeTableMap::ID, $id, $comparison);
    }
    ...
    public function filterByRolesSessionTypes($rolesSessionTypes, $comparison = null)
    {
        if ($rolesSessionTypes instanceof \org\bitbucket\phlopsi\access_control\propel\RolesSessionTypes) {
            return $this
                ->addUsingAlias(SessionTypeTableMap::ID, $rolesSessionTypes->getSessionTypeId(), $comparison);
    ...
    public function useRolesSessionTypesQuery($relationAlias = null, $joinType = Criteria::INNER_JOIN)
    {
        return $this
            ...
            ->useQuery($relationAlias ? $relationAlias : 'RolesSessionTypes', '\org\bitbucket\phlopsi\access_control\propel\RolesSessionTypesQuery');
    }
    ...
    public function filterBySessions($sessions, $comparison = null)
    {
        if ($sessions instanceof \org\bitbucket\phlopsi\access_control\propel\Sessions) {
            return $this
                ->addUsingAlias(SessionTypeTableMap::ID, $sessions->getSessionTypeId(), $comparison);
            ...
            throw new PropelException('filterBySessions() only accepts arguments of type \org\bitbucket\phlopsi\access_control\propel\Sessions or Collection');
        }
    }
    ...
    {
        if ($sessionType) {
            $this->addUsingAlias(SessionTypeTableMap::ID, $sessionType->getId(), Criteria::NOT_EQUAL);
        }
    ...
    /**
     * Performs a DELETE on the database, given a ChildSessionType or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or ChildSessionType object or primary key or array of primary keys
    ...
    public function orderByLevel($reverse = false)
    {
        if ($reverse) {
            return $this
                ->addAscendingOrderByColumn(ChildSessionType::RIGHT_COL);
        } else {
            return $this
                ->addDescendingOrderByColumn(ChildSessionType::RIGHT_COL);
        }
    }
    ...
    static public function shiftRLValues($delta, $first, $last = null, ConnectionInterface $con = null)
    {
        ...
        $valuesCriteria->add(ChildSessionType::LEFT_COL, array('raw' => ChildSessionType::LEFT_COL . ' + ?', 'value' => $delta), Criteria::CUSTOM_EQUAL);
        ...
        $valuesCriteria = new Criteria(SessionTypeTableMap::DATABASE_NAME);
        $valuesCriteria->add(ChildSessionType::RIGHT_COL, array('raw' => ChildSessionType::RIGHT_COL . ' + ?', 'value' => $delta), Criteria::CUSTOM_EQUAL);
    ...
    static public function shiftLevel($delta, $first, $last, ConnectionInterface $con = null)
    {
        ...
        $valuesCriteria = new Criteria(SessionTypeTableMap::DATABASE_NAME);
        $valuesCriteria->add(ChildSessionType::LEVEL_COL, array('raw' => ChildSessionType::LEVEL_COL . ' + ?', 'value' => $delta), Criteria::CUSTOM_EQUAL);
    ...
    static public function updateLoadedNodes($prune = null, ConnectionInterface $con = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            ...
            if (!empty($keys)) {
                ...
                // already in the pool.
                $criteria = new Criteria(SessionTypeTableMap::DATABASE_NAME);
                $criteria->add(SessionTypeTableMap::ID, $keys, Criteria::IN);
