...
abstract class RolesSessionTypes implements ActiveRecordInterface
{
     ...
     *
     * @return RolesSessionTypes The current object, for fluid interface
     */
    ...
    public function setRoleId($v)
    {
        ...
        if ($this->roles_id !== $v) {
            $this->roles_id = $v;
            $this->modifiedColumns[] = RolesSessionTypesTableMap::ROLES_ID;
        }
    ...
    public function setSessionTypeId($v)
    {
        ...
        if ($this->session_types_id !== $v) {
            ...
            $this->modifiedColumns[] = RolesSessionTypesTableMap::SESSION_TYPES_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \org\bitbucket\phlopsi\access_control\propel\RolesSessionTypes object", 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(RolesSessionTypesTableMap::ROLES_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ROLES_ID';
        }
        if ($this->isColumnModified(RolesSessionTypesTableMap::SESSION_TYPES_ID)) {
            $modifiedColumns[':p' . $index++]  = 'SESSION_TYPES_ID';
        }

        $sql = sprintf(
            'INSERT INTO roles_session_types (%s) VALUES (%s)',
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RolesSessionTypesTableMap::ROLES_ID)) $criteria->add(RolesSessionTypesTableMap::ROLES_ID, $this->roles_id);
        if ($this->isColumnModified(RolesSessionTypesTableMap::SESSION_TYPES_ID)) $criteria->add(RolesSessionTypesTableMap::SESSION_TYPES_ID, $this->session_types_id);
    ...
    {
        $criteria = new Criteria(RolesSessionTypesTableMap::DATABASE_NAME);
        $criteria->add(RolesSessionTypesTableMap::ROLES_ID, $this->roles_id);
        $criteria->add(RolesSessionTypesTableMap::SESSION_TYPES_ID, $this->session_types_id);
