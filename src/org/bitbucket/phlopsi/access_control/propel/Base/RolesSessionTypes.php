...
abstract class RolesSessionTypes implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\org\\bitbucket\\phlopsi\\access_control\\propel\\Map\\RolesSessionTypesTableMap';
    ...
    /**
     * Initializes internal state of org\bitbucket\phlopsi\access_control\propel\Base\RolesSessionTypes object.
     */
...
// hasOnlyDefaultValues()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : RolesSessionTypesTableMap::translateFieldName('RoleId',
                        TableMap::TYPE_PHPNAME, $indexType)];
            $this->roles_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : RolesSessionTypesTableMap::translateFieldName('SessionTypeId',
                        TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object',
                '\\org\\bitbucket\\phlopsi\\access_control\\propel\\RolesSessionTypes'), 0, $e);
        }
    }
...
// ensureConsistency
     ...
     * @return $this|\org\bitbucket\phlopsi\access_control\propel\RolesSessionTypes The current object (for fluent API support)
     */
...
// doSave()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO roles_session_types (%s) VALUES (%s)', implode(', ', $modifiedColumns),
    ...
    {
        if (isset($alreadyDumpedObjects['RolesSessionTypes'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aSessionType) {
                $result['SessionType'] = $this->aSessionType->toArray($keyType, $includeLazyLoadColumns,
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\org\bitbucket\phlopsi\access_control\propel\RolesSessionTypes
     */
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setSessionTypeId($arr[$keys[1]]);
        }
    }
     ...
     *
     * @return $this|\org\bitbucket\phlopsi\access_control\propel\RolesSessionTypes The current object, for fluid interface
     */
    ...
    public function hashCode()
    {
        $validPk = null !== $this->getRoleId() &&
            null !== $this->getSessionTypeId();

        $validPrimaryKeyFKs = 2;
        $primaryKeyFKs = [];

        //relation roles_session_types_fk_c5ae7d to table roles
        ...
        //relation roles_session_types_fk_5fa23c to table session_types
        if ($this->aSessionType && $hash = spl_object_hash($this->aSessionType)) {
            $primaryKeyFKs[] = $hash;
        } else {
            $validPrimaryKeyFKs = false;
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \org\bitbucket\phlopsi\access_control\propel\RolesSessionTypes (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \org\bitbucket\phlopsi\access_control\propel\RolesSessionTypes Clone of current object.
     * @throws PropelException
     */
