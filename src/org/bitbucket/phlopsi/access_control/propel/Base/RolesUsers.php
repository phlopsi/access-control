...
abstract class RolesUsers implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\org\\bitbucket\\phlopsi\\access_control\\propel\\Map\\RolesUsersTableMap';
    ...
    /**
     * Initializes internal state of org\bitbucket\phlopsi\access_control\propel\Base\RolesUsers object.
     */
    ...
    /**
     * Compares this with another <code>RolesUsers</code> instance.  If
     * <code>obj</code> is an instance of <code>RolesUsers</code>, delegates to
     * <code>equals(RolesUsers)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|RolesUsers The current object, for fluid interface
     */
...
// hasOnlyDefaultValues()
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : RolesUsersTableMap::translateFieldName('RoleId',
                        TableMap::TYPE_PHPNAME, $indexType)];
            $this->roles_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : RolesUsersTableMap::translateFieldName('UserId',
                        TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 2; // 2 = RolesUsersTableMap::NUM_HYDRATE_COLUMNS.
        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object',
                '\\org\\bitbucket\\phlopsi\\access_control\\propel\\RolesUsers'), 0, $e);
        }
    }
...
// ensureConsistency
     ...
     * @return $this|\org\bitbucket\phlopsi\access_control\propel\RolesUsers The current object (for fluent API support)
     */
    public function setRoleId($v)
    {
        ...
        if ($this->roles_id !== $v) {
            $this->roles_id = $v;
            $this->modifiedColumns[RolesUsersTableMap::COL_ROLES_ID] = true;
        }
...
// setRoleId()
    ...
    public function setUserId($v)
    {
        ...
        if ($this->users_id !== $v) {
            $this->users_id = $v;
            $this->modifiedColumns[RolesUsersTableMap::COL_USERS_ID] = true;
        }
...
// setUserId()
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildRolesUsersQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see RolesUsers::setDeleted()
     * @see RolesUsers::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildRolesUsersQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
                ...
                if ($ret) {
                    ...
                    $this->postSave($con);
                    RolesUsersTableMap::addInstanceToPool($this);
                } else {
                    $affectedRows = 0;
                }
...
// doSave()
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(RolesUsersTableMap::COL_ROLES_ID)) {
            $modifiedColumns[':p' . $index++] = 'ROLES_ID';
        }
        if ($this->isColumnModified(RolesUsersTableMap::COL_USERS_ID)) {
            $modifiedColumns[':p' . $index++] = 'USERS_ID';
        }

        $sql = sprintf(
            'INSERT INTO roles_users (%s) VALUES (%s)', implode(', ', $modifiedColumns),
    ...
    {
        $pos = RolesUsersTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['RolesUsers'][serialize($this->getPrimaryKey())])) {
            return '*RECURSION*';
        }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\org\bitbucket\phlopsi\access_control\propel\RolesUsers
     */
     ...
     *
     * @return $this|\org\bitbucket\phlopsi\access_control\propel\RolesUsers The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RolesUsersTableMap::COL_ROLES_ID)) {
            $criteria->add(RolesUsersTableMap::COL_ROLES_ID, $this->roles_id);
        }
        if ($this->isColumnModified(RolesUsersTableMap::COL_USERS_ID)) {
            $criteria->add(RolesUsersTableMap::COL_USERS_ID, $this->users_id);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \org\bitbucket\phlopsi\access_control\propel\RolesUsers (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \org\bitbucket\phlopsi\access_control\propel\RolesUsers Clone of current object.
     * @throws PropelException
     */
    ...
    public function getRole(ConnectionInterface $con = null)
    {
        if ($this->aRole === null && ($this->roles_id !== null)) {
            ...
            /* The following can be used additionally to
              ...
              $this->aRole->addRolesUserss($this);
             */
        }
    ...
    public function getUser(ConnectionInterface $con = null)
    {
        if ($this->aUser === null && ($this->users_id !== null)) {
            ...
            /* The following can be used additionally to
              ...
              undesirable since it could result in an only partially populated collection
              in the referenced object.
              $this->aUser->addRolesUserss($this);
             */
        }
    ...
    {
        if (null !== $this->aRole) {
            $this->aRole->removeRolesUsers($this);
        }
        if (null !== $this->aUser) {
            $this->aUser->removeRolesUsers($this);
        }
        $this->roles_id = null;
        $this->users_id = null;
        $this->alreadyInSave = false;
    ...
    {
        return (string) $this->exportTo(RolesUsersTableMap::DEFAULT_STRING_FORMAT);
    }
