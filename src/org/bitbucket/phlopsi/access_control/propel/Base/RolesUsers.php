...
abstract class RolesUsers implements ActiveRecordInterface
{
     ...
     *
     * @return RolesUsers The current object, for fluid interface
     */
    ...
    public function setRoleId($v)
    {
        ...
        if ($this->roles_id !== $v) {
            $this->roles_id = $v;
            $this->modifiedColumns[] = RolesUsersTableMap::ROLES_ID;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->users_id !== $v) {
            $this->users_id = $v;
            $this->modifiedColumns[] = RolesUsersTableMap::USERS_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException("Error populating \org\bitbucket\phlopsi\access_control\propel\RolesUsers object", 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(RolesUsersTableMap::ROLES_ID)) {
            $modifiedColumns[':p' . $index++]  = 'ROLES_ID';
        }
        if ($this->isColumnModified(RolesUsersTableMap::USERS_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(RolesUsersTableMap::ROLES_ID)) $criteria->add(RolesUsersTableMap::ROLES_ID, $this->roles_id);
        if ($this->isColumnModified(RolesUsersTableMap::USERS_ID)) $criteria->add(RolesUsersTableMap::USERS_ID, $this->users_id);
    ...
    {
        $criteria = new Criteria(RolesUsersTableMap::DATABASE_NAME);
        $criteria->add(RolesUsersTableMap::ROLES_ID, $this->roles_id);
        $criteria->add(RolesUsersTableMap::USERS_ID, $this->users_id);
