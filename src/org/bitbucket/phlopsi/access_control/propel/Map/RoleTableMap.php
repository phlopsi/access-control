...
class RoleTableMap extends TableMap
{
     ...
     */
    const EXTERNAL_ID = 'roles.EXTERNAL_ID';

    /**
     * the column name for the TREE_LEFT field
     */
    const TREE_LEFT = 'roles.TREE_LEFT';

    /**
     * the column name for the TREE_RIGHT field
     */
    const TREE_RIGHT = 'roles.TREE_RIGHT';

    /**
     * the column name for the TREE_LEVEL field
     */
    const TREE_LEVEL = 'roles.TREE_LEVEL';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(RoleTableMap::EXTERNAL_ID, RoleTableMap::TREE_LEFT, RoleTableMap::TREE_RIGHT, RoleTableMap::TREE_LEVEL, RoleTableMap::ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(RoleTableMap::EXTERNAL_ID => 0, RoleTableMap::TREE_LEFT => 1, RoleTableMap::TREE_RIGHT => 2, RoleTableMap::TREE_LEVEL => 3, RoleTableMap::ID => 4, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(RoleTableMap::EXTERNAL_ID);
            $criteria->addSelectColumn(RoleTableMap::TREE_LEFT);
            $criteria->addSelectColumn(RoleTableMap::TREE_RIGHT);
            $criteria->addSelectColumn(RoleTableMap::TREE_LEVEL);
