...
use TableMapTrait;
    ...
    protected static $fieldNames = array(
        ...
        self::TYPE_COLNAME => array(PermissionTableMap::COL_EXTERNAL_ID, PermissionTableMap::COL_TREE_LEFT, PermissionTableMap::COL_TREE_RIGHT,
            PermissionTableMap::COL_TREE_LEVEL, PermissionTableMap::COL_ID,),
    ...
    protected static $fieldKeys = array(
        ...
        self::TYPE_COLNAME => array(PermissionTableMap::COL_EXTERNAL_ID => 0, PermissionTableMap::COL_TREE_LEFT => 1, PermissionTableMap::COL_TREE_RIGHT => 2,
            PermissionTableMap::COL_TREE_LEVEL => 3, PermissionTableMap::COL_ID => 4,),
...
// initialize()
    ...
    public function buildRelations()
    {
        $this->addRelation('PermissionsRoles', '\\org\\bitbucket\\phlopsi\\access_control\\propel\\PermissionsRoles',
            RelationMap::ONE_TO_MANY, array('id' => 'permissions_id',), null, null, 'PermissionsRoless');
...
// getBehaviors()
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PermissionTableMap::COL_EXTERNAL_ID);
            $criteria->addSelectColumn(PermissionTableMap::COL_TREE_LEFT);
            $criteria->addSelectColumn(PermissionTableMap::COL_TREE_RIGHT);
