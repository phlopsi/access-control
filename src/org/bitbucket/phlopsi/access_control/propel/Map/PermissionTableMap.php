...
class PermissionTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(PermissionTableMap::EXTERNAL_ID, PermissionTableMap::TREE_LEFT, PermissionTableMap::TREE_RIGHT, PermissionTableMap::TREE_LEVEL, PermissionTableMap::ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(PermissionTableMap::EXTERNAL_ID => 0, PermissionTableMap::TREE_LEFT => 1, PermissionTableMap::TREE_RIGHT => 2, PermissionTableMap::TREE_LEVEL => 3, PermissionTableMap::ID => 4, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PermissionTableMap::EXTERNAL_ID);
            $criteria->addSelectColumn(PermissionTableMap::TREE_LEFT);
            $criteria->addSelectColumn(PermissionTableMap::TREE_RIGHT);
            $criteria->addSelectColumn(PermissionTableMap::TREE_LEVEL);
