...
use phlopsi\access_control\propel\PermissionsRoles;
use phlopsi\access_control\propel\PermissionsRolesQuery;
...
class PermissionsRolesTableMap extends TableMap
{
     ...
     * and findPk*() calls.
     *
     * @param \phlopsi\access_control\propel\PermissionsRoles $obj A \phlopsi\access_control\propel\PermissionsRoles object.
     ...
     *
     * @param mixed $value A \phlopsi\access_control\propel\PermissionsRoles object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \phlopsi\access_control\propel\PermissionsRoles) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \phlopsi\access_control\propel\PermissionsRoles object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \phlopsi\access_control\propel\PermissionsRoles) { // it's a model object
