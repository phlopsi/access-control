...
class PermissionTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(PermissionTableMap::COL_EXTERNAL_ID, PermissionTableMap::COL_ID, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(PermissionTableMap::COL_EXTERNAL_ID => 0, PermissionTableMap::COL_ID => 1, ),
    ...
    public static function doDelete($values, ConnectionInterface $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Phlopsi\AccessControl\Propel\Permission) { // it's a model object
