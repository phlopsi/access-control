...
use Phlopsi\AccessControl\Propel\RolesSessionTypes;
use Phlopsi\AccessControl\Propel\RolesSessionTypesQuery;
...
class RolesSessionTypesTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Phlopsi.AccessControl.Propel.Map.RolesSessionTypesTableMap';
     ...
     */
    const OM_CLASS = '\\Phlopsi\\AccessControl\\Propel\\RolesSessionTypes';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Phlopsi.AccessControl.Propel.RolesSessionTypes';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Phlopsi\\AccessControl\\Propel\\RolesSessionTypes');
    ...
    public function buildRelations()
    {
        ...
        $this->addRelation('SessionType', '\\Phlopsi\\AccessControl\\Propel\\SessionType', RelationMap::MANY_TO_ONE, array('session_types_id' => 'id', ), null, null);
    } // buildRelations()
     ...
     * and findPk*() calls.
     *
     * @param \Phlopsi\AccessControl\Propel\RolesSessionTypes $obj A \Phlopsi\AccessControl\Propel\RolesSessionTypes object.
     ...
     *
     * @param mixed $value A \Phlopsi\AccessControl\Propel\RolesSessionTypes object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Phlopsi\AccessControl\Propel\RolesSessionTypes) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Phlopsi\AccessControl\Propel\RolesSessionTypes object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Phlopsi\AccessControl\Propel\RolesSessionTypes) { // it's a model object
