...
use Phlopsi\AccessControl\Propel\SessionType;
use Phlopsi\AccessControl\Propel\SessionTypeQuery;
...
class SessionTypeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Phlopsi.AccessControl.Propel.Map.SessionTypeTableMap';
     ...
     */
    const TABLE_NAME = 'session_types';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\Phlopsi\\AccessControl\\Propel\\SessionType';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Phlopsi.AccessControl.Propel.SessionType';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Phlopsi\\AccessControl\\Propel\\SessionType');
    ...
    {
        $this->addRelation('RolesSessionTypes', '\\Phlopsi\\AccessControl\\Propel\\RolesSessionTypes', RelationMap::ONE_TO_MANY, array('id' => 'session_types_id', ), null, null, 'RolesSessionTypess');
    ...
    {
        return $withPrefix ? SessionTypeTableMap::CLASS_DEFAULT : SessionTypeTableMap::OM_CLASS;
    }
    ...
    {
        $key = SessionTypeTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = SessionTypeTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = SessionTypeTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(SessionTypeTableMap::DATABASE_NAME)->getTable(SessionTypeTableMap::TABLE_NAME);
    }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Phlopsi\AccessControl\Propel\SessionType) { // it's a model object
     ...
     *
     * @param mixed               $criteria Criteria or SessionType object containing data that is used to create the INSERT statement.
