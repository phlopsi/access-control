...
class RolesUsersTableMap extends TableMap
{
     ...
     * and findPk*() calls.
     *
     * @param \Phlopsi\AccessControl\Propel\RolesUsers $obj A \Phlopsi\AccessControl\Propel\RolesUsers object.
     ...
     *
     * @param mixed $value A \Phlopsi\AccessControl\Propel\RolesUsers object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Phlopsi\AccessControl\Propel\RolesUsers) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Phlopsi\AccessControl\Propel\RolesUsers object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    public static function doDelete($values, ConnectionInterface $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Phlopsi\AccessControl\Propel\RolesUsers) { // it's a model object
