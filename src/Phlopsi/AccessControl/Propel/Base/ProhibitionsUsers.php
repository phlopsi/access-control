...
abstract class ProhibitionsUsers implements ActiveRecordInterface
{
    ...
    /**
     * Initializes internal state of Phlopsi\AccessControl\Propel\Base\ProhibitionsUsers object.
     */
    ...
    /**
     * Compares this with another <code>ProhibitionsUsers</code> instance.  If
     * <code>obj</code> is an instance of <code>ProhibitionsUsers</code>, delegates to
     * <code>equals(ProhibitionsUsers)</code>.  Otherwise, returns <code>false</code>.
     *
    ...
    /**
     * Get the [optionally formatted] temporal [prohibited_until] column value.
     *
     *
    ...
    public function getProhibitedUntil($format = NULL)
    {
        if ($format === null) {
            ...
            return $this->prohibited_until instanceof \DateTime ? $this->prohibited_until->format($format) : null;
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildProhibitionsUsersQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ProhibitionsUsers::setDeleted()
     * @see ProhibitionsUsers::isDeleted()
     */
    ...
    {
        $pos = ProhibitionsUsersTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            ...
            case 1:
                ...
                break;
            case 2:
                return $this->getProhibitedUntil();
                break;
            case 3:
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            ...
            $keys[2] => $this->getProhibitedUntil(),
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Phlopsi\AccessControl\Propel\ProhibitionsUsers (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setProhibitedUntil($this->getProhibitedUntil());
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Phlopsi\AccessControl\Propel\ProhibitionsUsers Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(ProhibitionsUsersTableMap::DEFAULT_STRING_FORMAT);
    }
