...
abstract class PermissionsRoles implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Phlopsi\\AccessControl\\Propel\\Map\\PermissionsRolesTableMap';
    ...
    /**
     * Initializes internal state of Phlopsi\AccessControl\Propel\Base\PermissionsRoles object.
     */
    ...
    /**
     * Compares this with another <code>PermissionsRoles</code> instance.  If
     * <code>obj</code> is an instance of <code>PermissionsRoles</code>, delegates to
     * <code>equals(PermissionsRoles)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PermissionsRoles The current object, for fluid interface
     */
    ...
    public function setPermissionId($v)
    {
        ...
        if ($this->permissions_id !== $v) {
            ...
            $this->modifiedColumns[PermissionsRolesTableMap::COL_PERMISSIONS_ID] = true;
        }
    ...
    public function setRoleId($v)
    {
        ...
        if ($this->roles_id !== $v) {
            $this->roles_id = $v;
            $this->modifiedColumns[PermissionsRolesTableMap::COL_ROLES_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Phlopsi\\AccessControl\\Propel\\PermissionsRoles'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPermissionsRolesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PermissionsRoles::setDeleted()
     * @see PermissionsRoles::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPermissionsRolesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PermissionsRolesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PermissionsRolesTableMap::COL_PERMISSIONS_ID)) {
            $modifiedColumns[':p' . $index++]  = 'permissions_id';
        }
        if ($this->isColumnModified(PermissionsRolesTableMap::COL_ROLES_ID)) {
    ...
    {
        $pos = PermissionsRolesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['PermissionsRoles'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PermissionsRoles'][$this->hashCode()] = true;
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Phlopsi\AccessControl\Propel\PermissionsRoles
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Phlopsi\AccessControl\Propel\PermissionsRoles The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PermissionsRolesTableMap::COL_PERMISSIONS_ID)) {
            $criteria->add(PermissionsRolesTableMap::COL_PERMISSIONS_ID, $this->permissions_id);
        }
        if ($this->isColumnModified(PermissionsRolesTableMap::COL_ROLES_ID)) {
            $criteria->add(PermissionsRolesTableMap::COL_ROLES_ID, $this->roles_id);
        }
    ...
    {
        $criteria = ChildPermissionsRolesQuery::create();
        $criteria->add(PermissionsRolesTableMap::COL_PERMISSIONS_ID, $this->permissions_id);
        $criteria->add(PermissionsRolesTableMap::COL_ROLES_ID, $this->roles_id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Phlopsi\AccessControl\Propel\PermissionsRoles (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Phlopsi\AccessControl\Propel\PermissionsRoles Clone of current object.
     * @throws PropelException
     */
    ...
    public function getPermission(ConnectionInterface $con = null)
    {
        if ($this->aPermission === null && ($this->permissions_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aPermission->addPermissionsRoless($this);
             */
        }
    ...
    public function getRole(ConnectionInterface $con = null)
    {
        if ($this->aRole === null && ($this->roles_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aRole->addPermissionsRoless($this);
             */
        }
    ...
    {
        if (null !== $this->aPermission) {
            $this->aPermission->removePermissionsRoles($this);
        }
        if (null !== $this->aRole) {
            $this->aRole->removePermissionsRoles($this);
        }
    ...
    {
        return (string) $this->exportTo(PermissionsRolesTableMap::DEFAULT_STRING_FORMAT);
    }
